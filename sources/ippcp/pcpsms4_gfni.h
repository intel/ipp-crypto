...
__FORCEINLINE __m512i L512(__m512i x)
{
   ...
   __m512i res     = _mm512_ternarylogic_epi32(rolled0, rolled1, rolled2, 0x96);
           res     = _mm512_xor_si512(res, rolled3);
   return  res;
}
...
__FORCEINLINE __m128i L128(__m128i x)
{
   ...
   __m128i res     = _mm_ternarylogic_epi32(rolled0, rolled1, rolled2, 0x96);
           res     = _mm_xor_si128(res, rolled3);
   return  res;
}
