...
// | 8 - take from B
static __ALIGN64 Ipp8u permMask_out_low[] = { 0,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 1,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           0 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 1 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           4,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 5,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           4 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 5 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
static __ALIGN64 Ipp8u permMask_out_hi[] = { 2,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           2 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 3 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           6,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 7,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           6 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 7 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };

static __ALIGN64 Ipp8u permMask_out_low128[] = { 0,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 1,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           2,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           0 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 1 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           2 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 3 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
static __ALIGN64 Ipp8u permMask_out_hi128[] = { 4,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 5,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           6,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 7,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           4 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 5 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                                           6 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 7 | 8,0x00,0x00,0x00,0x00,0x00,0x00,0x00 };
...
{
   __m512i T = _mm512_xor_si512(_mm512_slli_epi32(x, 2), _mm512_srli_epi32(x, 30));

   T = _mm512_xor_si512(T, _mm512_slli_epi32(x, 10));
   T = _mm512_xor_si512(T, _mm512_srli_epi32(x, 22));

   T = _mm512_xor_si512(T, _mm512_slli_epi32(x, 18));
   T = _mm512_xor_si512(T, _mm512_srli_epi32(x, 14));

   T = _mm512_xor_si512(T, _mm512_slli_epi32(x, 24));
   T = _mm512_xor_si512(T, _mm512_srli_epi32(x, 8));
   return T;
}
...
#define TRANSPOSE_OUT_512(T0,T1,T2,T3, K0,K1,K2,K3) \
   T0 = _mm512_unpacklo_epi32(K1, K0); \
   T1 = _mm512_unpacklo_epi32(K3, K2); \
   T2 = _mm512_unpackhi_epi32(K1, K0); \
   T3 = _mm512_unpackhi_epi32(K3, K2); \
\
   K0 = _mm512_unpacklo_epi64(T1, T0); \
   K1 = _mm512_unpacklo_epi64(T3, T2); \
   K2 = _mm512_unpackhi_epi64(T1, T0); \
   K3 = _mm512_unpackhi_epi64(T3, T2); \
\
   T0 = _mm512_permutex2var_epi64(K0, M512(permMask_out_low), K2); \
   T1 = _mm512_permutex2var_epi64(K1, M512(permMask_out_low), K3); \
   T2 = _mm512_permutex2var_epi64(K0, M512(permMask_out_hi), K2); \
   T3 = _mm512_permutex2var_epi64(K1, M512(permMask_out_hi), K3);\
\
   K0 = _mm512_permutex2var_epi64(T0, M512(permMask_out_low128), T1); \
   K1 = _mm512_permutex2var_epi64(T2, M512(permMask_out_low128), T3); \
   K2 = _mm512_permutex2var_epi64(T0, M512(permMask_out_hi128), T1); \
   K3 = _mm512_permutex2var_epi64(T2, M512(permMask_out_hi128), T3);\
\
