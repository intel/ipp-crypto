...
.globl e9_TransformNative2Composite
.type e9_TransformNative2Composite, @function
 
e9_TransformNative2Composite:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size e9_TransformNative2Composite, .Lfe1-(e9_TransformNative2Composite)
.p2align 5, 0x90
 
.globl e9_SafeEncrypt_RIJ128
.type e9_SafeEncrypt_RIJ128, @function
 
e9_SafeEncrypt_RIJ128:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size e9_SafeEncrypt_RIJ128, .Lfe2-(e9_SafeEncrypt_RIJ128)
