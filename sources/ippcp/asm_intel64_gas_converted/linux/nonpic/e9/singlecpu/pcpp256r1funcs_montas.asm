...
vzeroupper 
    ...
    ret
.Lfe9:
.size p256r1_sqr_montl, .Lfe9-(p256r1_sqr_montl)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe10:
.size p256r1_mont_back, .Lfe10-(p256r1_mont_back)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe11:
.size p256r1_select_pp_w5, .Lfe11-(p256r1_select_pp_w5)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe12:
.size p256r1_select_ap_w7, .Lfe12-(p256r1_select_ap_w7)
