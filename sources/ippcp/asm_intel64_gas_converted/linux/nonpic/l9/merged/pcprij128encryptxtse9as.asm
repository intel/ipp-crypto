...
.globl l9_cpAESEncryptXTS_AES_NI
.type l9_cpAESEncryptXTS_AES_NI, @function
 
l9_cpAESEncryptXTS_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_cpAESEncryptXTS_AES_NI, .Lfe1-(l9_cpAESEncryptXTS_AES_NI)
