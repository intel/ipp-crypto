...
.globl l9_AesGcmMulGcm_table2K
.type l9_AesGcmMulGcm_table2K, @function
 
l9_AesGcmMulGcm_table2K:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_AesGcmMulGcm_table2K, .Lfe1-(l9_AesGcmMulGcm_table2K)
.p2align 5, 0x90
 
.globl l9_AesGcmAuth_table2K
.type l9_AesGcmAuth_table2K, @function
 
l9_AesGcmAuth_table2K:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size l9_AesGcmAuth_table2K, .Lfe2-(l9_AesGcmAuth_table2K)
