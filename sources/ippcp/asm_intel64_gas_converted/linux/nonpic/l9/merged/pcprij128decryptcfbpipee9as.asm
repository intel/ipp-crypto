...
.globl l9_DecryptCFB_RIJ128pipe_AES_NI
.type l9_DecryptCFB_RIJ128pipe_AES_NI, @function
 
l9_DecryptCFB_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(l9_DecryptCFB_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl l9_DecryptCFB32_RIJ128pipe_AES_NI
.type l9_DecryptCFB32_RIJ128pipe_AES_NI, @function
 
l9_DecryptCFB32_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size l9_DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(l9_DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl l9_DecryptCFB128_RIJ128pipe_AES_NI
.type l9_DecryptCFB128_RIJ128pipe_AES_NI, @function
 
l9_DecryptCFB128_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe3:
.size l9_DecryptCFB128_RIJ128pipe_AES_NI, .Lfe3-(l9_DecryptCFB128_RIJ128pipe_AES_NI)
