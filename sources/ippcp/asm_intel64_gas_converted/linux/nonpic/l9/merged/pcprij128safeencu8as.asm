...
.globl l9_TransformNative2Composite
.type l9_TransformNative2Composite, @function
 
l9_TransformNative2Composite:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_TransformNative2Composite, .Lfe1-(l9_TransformNative2Composite)
.p2align 5, 0x90
 
.globl l9_SafeEncrypt_RIJ128
.type l9_SafeEncrypt_RIJ128, @function
 
l9_SafeEncrypt_RIJ128:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size l9_SafeEncrypt_RIJ128, .Lfe2-(l9_SafeEncrypt_RIJ128)
