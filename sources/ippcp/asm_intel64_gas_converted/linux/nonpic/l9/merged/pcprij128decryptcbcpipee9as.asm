...
.globl l9_DecryptCBC_RIJ128pipe_AES_NI
.type l9_DecryptCBC_RIJ128pipe_AES_NI, @function
 
l9_DecryptCBC_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_DecryptCBC_RIJ128pipe_AES_NI, .Lfe1-(l9_DecryptCBC_RIJ128pipe_AES_NI)
