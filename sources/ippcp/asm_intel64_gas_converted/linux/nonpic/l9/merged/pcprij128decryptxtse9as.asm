...
.globl l9_cpAESDecryptXTS_AES_NI
.type l9_cpAESDecryptXTS_AES_NI, @function
 
l9_cpAESDecryptXTS_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_cpAESDecryptXTS_AES_NI, .Lfe1-(l9_cpAESDecryptXTS_AES_NI)
