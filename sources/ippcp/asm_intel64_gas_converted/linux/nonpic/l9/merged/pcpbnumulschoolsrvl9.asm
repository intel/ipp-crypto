...
mred1_start:
    ...
    ret
.Lfe5:
.size mred1_start, .Lfe5-(mred1_start)
.p2align 4, 0x90
...
mred2_start:
    ...
    ret
.Lfe6:
.size mred2_start, .Lfe6-(mred2_start)
.p2align 4, 0x90
...
mred3_start:
    ...
    ret
.Lfe7:
.size mred3_start, .Lfe7-(mred3_start)
.p2align 4, 0x90
...
mred4_start:
    ...
    ret
.Lfe8:
.size mred4_start, .Lfe8-(mred4_start)
.p2align 4, 0x90
...
mred5_start:
    ...
    ret
.Lfe9:
.size mred5_start, .Lfe9-(mred5_start)
.p2align 4, 0x90
...
mred6_start:
    ...
    ret
.Lfe10:
.size mred6_start, .Lfe10-(mred6_start)
.p2align 4, 0x90
...
mred7_start:
    ...
    ret
.Lfe11:
.size mred7_start, .Lfe11-(mred7_start)
.p2align 4, 0x90
...
mred8_start:
    ...
    ret
.Lfe12:
.size mred8_start, .Lfe12-(mred8_start)
.p2align 4, 0x90
...
mred8x1_start:
    ...
    ret
.Lfe13:
.size mred8x1_start, .Lfe13-(mred8x1_start)
.p2align 4, 0x90
...
mred8x2_start:
    ...
    ret
.Lfe14:
.size mred8x2_start, .Lfe14-(mred8x2_start)
.p2align 4, 0x90
...
mred8x3_start:
    ...
    ret
.Lfe15:
.size mred8x3_start, .Lfe15-(mred8x3_start)
.p2align 4, 0x90
...
mred8x4_start:
    ...
    ret
.Lfe16:
.size mred8x4_start, .Lfe16-(mred8x4_start)
.p2align 4, 0x90
...
mred8x5_start:
    ...
    ret
.Lfe17:
.size mred8x5_start, .Lfe17-(mred8x5_start)
.p2align 4, 0x90
...
mred8x6_start:
    ...
    ret
.Lfe18:
.size mred8x6_start, .Lfe18-(mred8x6_start)
.p2align 4, 0x90
...
mred8x7_start:
    ...
    ret
.Lfe19:
.size mred8x7_start, .Lfe19-(mred8x7_start)
.p2align 4, 0x90
...
mred8x8_start:
    ...
    ret
.Lfe20:
.size mred8x8_start, .Lfe20-(mred8x8_start)
.p2align 4, 0x90
...
vzeroupper 
    ...
    ret
.Lfe35:
.size l9_cpMulAdc_BNU_school, .Lfe35-(l9_cpMulAdc_BNU_school)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe36:
.size l9_cpSqrAdc_BNU_school, .Lfe36-(l9_cpSqrAdc_BNU_school)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe37:
.size l9_cpMontRedAdc_BNU, .Lfe37-(l9_cpMontRedAdc_BNU)
