...
.globl y8_DecryptCBC_RIJ128pipe_AES_NI
.type y8_DecryptCBC_RIJ128pipe_AES_NI, @function
 
y8_DecryptCBC_RIJ128pipe_AES_NI:
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size y8_DecryptCBC_RIJ128pipe_AES_NI, .Lfe1-(y8_DecryptCBC_RIJ128pipe_AES_NI)
