...
.globl y8_DecryptCFB_RIJ128pipe_AES_NI
.type y8_DecryptCFB_RIJ128pipe_AES_NI, @function
 
y8_DecryptCFB_RIJ128pipe_AES_NI:
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size y8_DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(y8_DecryptCFB_RIJ128pipe_AES_NI)
.p2align 4, 0x90
 
.globl y8_DecryptCFB32_RIJ128pipe_AES_NI
.type y8_DecryptCFB32_RIJ128pipe_AES_NI, @function
 
y8_DecryptCFB32_RIJ128pipe_AES_NI:
...
.Lquitgas_2: 
    ...
    ret
.Lfe2:
.size y8_DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(y8_DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 4, 0x90
 
.globl y8_DecryptCFB128_RIJ128pipe_AES_NI
.type y8_DecryptCFB128_RIJ128pipe_AES_NI, @function
 
y8_DecryptCFB128_RIJ128pipe_AES_NI:
...
.Lquitgas_3: 
    ...
    ret
.Lfe3:
.size y8_DecryptCFB128_RIJ128pipe_AES_NI, .Lfe3-(y8_DecryptCFB128_RIJ128pipe_AES_NI)
