...
.globl y8_TransformNative2Composite
.type y8_TransformNative2Composite, @function
 
y8_TransformNative2Composite:
    ...
    ret
.Lfe1:
.size y8_TransformNative2Composite, .Lfe1-(y8_TransformNative2Composite)
.p2align 4, 0x90
 
.globl y8_SafeEncrypt_RIJ128
.type y8_SafeEncrypt_RIJ128, @function
 
y8_SafeEncrypt_RIJ128:
...
.Lencode_roundgas_2: 
    ...
    ret
.Lfe2:
.size y8_SafeEncrypt_RIJ128, .Lfe2-(y8_SafeEncrypt_RIJ128)
