...
.globl y8_AesGcmMulGcm_table2K
.type y8_AesGcmMulGcm_table2K, @function
 
y8_AesGcmMulGcm_table2K:
    ...
    ret
.Lfe1:
.size y8_AesGcmMulGcm_table2K, .Lfe1-(y8_AesGcmMulGcm_table2K)
.p2align 4, 0x90
 
.globl y8_AesGcmAuth_table2K
.type y8_AesGcmAuth_table2K, @function
 
y8_AesGcmAuth_table2K:
...
.Lauth_loopgas_2: 
    ...
    ret
.Lfe2:
.size y8_AesGcmAuth_table2K, .Lfe2-(y8_AesGcmAuth_table2K)
