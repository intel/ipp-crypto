...
.globl n8_AesGcmMulGcm_table2K
.type n8_AesGcmMulGcm_table2K, @function
 
n8_AesGcmMulGcm_table2K:
    ...
    ret
.Lfe1:
.size n8_AesGcmMulGcm_table2K, .Lfe1-(n8_AesGcmMulGcm_table2K)
.p2align 4, 0x90
 
.globl n8_AesGcmAuth_table2K
.type n8_AesGcmAuth_table2K, @function
 
n8_AesGcmAuth_table2K:
...
.Lauth_loopgas_2: 
    ...
    ret
.Lfe2:
.size n8_AesGcmAuth_table2K, .Lfe2-(n8_AesGcmAuth_table2K)
