...
.globl n8_TransformNative2Composite
.type n8_TransformNative2Composite, @function
 
n8_TransformNative2Composite:
    ...
    ret
.Lfe1:
.size n8_TransformNative2Composite, .Lfe1-(n8_TransformNative2Composite)
.p2align 4, 0x90
 
.globl n8_SafeEncrypt_RIJ128
.type n8_SafeEncrypt_RIJ128, @function
 
n8_SafeEncrypt_RIJ128:
...
.Lencode_roundgas_2: 
    ...
    ret
.Lfe2:
.size n8_SafeEncrypt_RIJ128, .Lfe2-(n8_SafeEncrypt_RIJ128)
