...
.globl cpMontSqr1024_avx2
.type cpMontSqr1024_avx2, @function
...
vzeroupper 
    ...
    ret
.Lfe1:
.size cpMontSqr1024_avx2, .Lfe1-(cpMontSqr1024_avx2)
.p2align 6, 0x90
 
.globl cpSqr1024_avx2
.type cpSqr1024_avx2, @function
...
vzeroupper 
    ...
    ret
.Lfe2:
.size cpSqr1024_avx2, .Lfe2-(cpSqr1024_avx2)
.p2align 6, 0x90
 
.globl cpMontRed1024_avx2
.type cpMontRed1024_avx2, @function
