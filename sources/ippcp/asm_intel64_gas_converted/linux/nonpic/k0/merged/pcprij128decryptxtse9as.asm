...
.globl k0_cpAESDecryptXTS_AES_NI
.type k0_cpAESDecryptXTS_AES_NI, @function
 
k0_cpAESDecryptXTS_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_cpAESDecryptXTS_AES_NI, .Lfe1-(k0_cpAESDecryptXTS_AES_NI)
