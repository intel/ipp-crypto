...
.globl k0_cpMontMul4n_avx2
.type k0_cpMontMul4n_avx2, @function
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_cpMontMul4n_avx2, .Lfe1-(k0_cpMontMul4n_avx2)
.p2align 6, 0x90
 
.globl k0_cpMontMul4n1_avx2
.type k0_cpMontMul4n1_avx2, @function
 
k0_cpMontMul4n1_avx2:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size k0_cpMontMul4n1_avx2, .Lfe2-(k0_cpMontMul4n1_avx2)
.p2align 6, 0x90
 
.globl k0_cpMontMul4n2_avx2
.type k0_cpMontMul4n2_avx2, @function
 
k0_cpMontMul4n2_avx2:
...
vzeroupper 
    ...
    ret
.Lfe3:
.size k0_cpMontMul4n2_avx2, .Lfe3-(k0_cpMontMul4n2_avx2)
.p2align 6, 0x90
 
.globl k0_cpMontMul4n3_avx2
.type k0_cpMontMul4n3_avx2, @function
 
k0_cpMontMul4n3_avx2:
...
vzeroupper 
    ...
    ret
.Lfe4:
.size k0_cpMontMul4n3_avx2, .Lfe4-(k0_cpMontMul4n3_avx2)
