...
.globl k0_AesGcmMulGcm_table2K
.type k0_AesGcmMulGcm_table2K, @function
 
k0_AesGcmMulGcm_table2K:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_AesGcmMulGcm_table2K, .Lfe1-(k0_AesGcmMulGcm_table2K)
.p2align 6, 0x90
 
.globl k0_AesGcmAuth_table2K
.type k0_AesGcmAuth_table2K, @function
 
k0_AesGcmAuth_table2K:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size k0_AesGcmAuth_table2K, .Lfe2-(k0_AesGcmAuth_table2K)
