...
.globl n0_cpAESEncryptXTS_AES_NI
.type n0_cpAESEncryptXTS_AES_NI, @function
 
n0_cpAESEncryptXTS_AES_NI:
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size n0_cpAESEncryptXTS_AES_NI, .Lfe1-(n0_cpAESEncryptXTS_AES_NI)
