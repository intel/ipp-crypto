...
.globl n0_mul_8Nx8M_adcox
.type n0_mul_8Nx8M_adcox, @function
...
.Lmla_enrtygas_1: 
    ...
    ret
.Lfe1:
.size n0_mul_8Nx8M_adcox, .Lfe1-(n0_mul_8Nx8M_adcox)
.p2align 4, 0x90
mla_simple: 
    xor          %rax, %rax
    mov          %rdx, %r11
...
.globl n0_mul_NxM_adcox
.type n0_mul_NxM_adcox, @function
...
.Lquitgas_2: 
    ...
    ret
.Lfe2:
.size n0_mul_NxM_adcox, .Lfe2-(n0_mul_NxM_adcox)
...
.globl n0_sqr_8N_adcox
.type n0_sqr_8N_adcox, @function
...
.Lupdate_Trianglegas_3: 
    ...
    ret
.Lfe3:
.size n0_sqr_8N_adcox, .Lfe3-(n0_sqr_8N_adcox)
.p2align 4, 0x90
 
.globl n0_sqr_N_adcox
.type n0_sqr_N_adcox, @function
...
.Lquitgas_4: 
    ret
.Lfe4:
.size n0_sqr_N_adcox, .Lfe4-(n0_sqr_N_adcox)
...
.globl n0_mred_8N_adcox
.type n0_mred_8N_adcox, @function
...
.LentryInnerLoopgas_5: 
    ...
    ret
.Lfe5:
.size n0_mred_8N_adcox, .Lfe5-(n0_mred_8N_adcox)
.p2align 4, 0x90
 
.globl n0_mred_N_adcox
.type n0_mred_N_adcox, @function
...
.Lcomplete_reductiongas_6: 
    ...
    ret
.Lfe6:
.size n0_mred_N_adcox, .Lfe6-(n0_mred_N_adcox)
 
.p2align 6, 0x90
 
.globl n0_cpMulAdx_BNU_school
.type n0_cpMulAdx_BNU_school, @function
 
n0_cpMulAdx_BNU_school:
...
.Ltest_8N_casegas_7: 
    ...
    call         n0_mul_8Nx8M_adcox
    jmp          .Lquitgas_7
.Lgeneral_mulgas_7: 
    call         n0_mul_NxM_adcox
    jmp          .Lquitgas_7
.Lquitgas_7: 
    ...
    ret
.Lfe7:
.size n0_cpMulAdx_BNU_school, .Lfe7-(n0_cpMulAdx_BNU_school)
.p2align 6, 0x90
 
.globl n0_cpSqrAdx_BNU_school
.type n0_cpSqrAdx_BNU_school, @function
 
n0_cpSqrAdx_BNU_school:
...
.Lquitgas_8: 
    ...
    ret
.Lfe8:
.size n0_cpSqrAdx_BNU_school, .Lfe8-(n0_cpSqrAdx_BNU_school)
.p2align 6, 0x90
 
.globl n0_cpMontRedAdx_BNU
.type n0_cpMontRedAdx_BNU, @function
...
.Ltest_8N_casegas_9: 
    ...
    call         n0_mred_8N_adcox
    jmp          .Lquitgas_9
.Lgeneral_casegas_9: 
    call         n0_mred_N_adcox
.Lquitgas_9: 
    ...
    ret
.Lfe9:
.size n0_cpMontRedAdx_BNU, .Lfe9-(n0_cpMontRedAdx_BNU)
