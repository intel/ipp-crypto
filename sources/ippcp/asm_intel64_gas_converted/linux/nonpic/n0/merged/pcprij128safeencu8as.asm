...
.globl n0_TransformNative2Composite
.type n0_TransformNative2Composite, @function
 
n0_TransformNative2Composite:
    ...
    ret
.Lfe1:
.size n0_TransformNative2Composite, .Lfe1-(n0_TransformNative2Composite)
.p2align 6, 0x90
 
.globl n0_SafeEncrypt_RIJ128
.type n0_SafeEncrypt_RIJ128, @function
 
n0_SafeEncrypt_RIJ128:
...
.Lencode_roundgas_2: 
    ...
    ret
.Lfe2:
.size n0_SafeEncrypt_RIJ128, .Lfe2-(n0_SafeEncrypt_RIJ128)
