...
vzeroupper 
    ...
    ret
.Lfe9:
.size sm2_sqr_montl, .Lfe9-(sm2_sqr_montl)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe10:
.size sm2_mont_back, .Lfe10-(sm2_mont_back)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe11:
.size sm2_select_pp_w5, .Lfe11-(sm2_select_pp_w5)
.p2align 5, 0x90
...
vzeroupper 
    ...
    ret
.Lfe12:
.size sm2_select_ap_w7, .Lfe12-(sm2_select_ap_w7)
