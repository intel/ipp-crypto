...
.globl DecryptCFB_RIJ128pipe_AES_NI
.type DecryptCFB_RIJ128pipe_AES_NI, @function
...
vzeroupper 
    ...
    ret
.Lfe1:
.size DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(DecryptCFB_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl DecryptCFB32_RIJ128pipe_AES_NI
.type DecryptCFB32_RIJ128pipe_AES_NI, @function
 
DecryptCFB32_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl DecryptCFB128_RIJ128pipe_AES_NI
.type DecryptCFB128_RIJ128pipe_AES_NI, @function
...
vzeroupper 
    ...
    ret
.Lfe3:
.size DecryptCFB128_RIJ128pipe_AES_NI, .Lfe3-(DecryptCFB128_RIJ128pipe_AES_NI)
