...
.globl e9_DecryptCBC_RIJ128pipe_AES_NI
.type e9_DecryptCBC_RIJ128pipe_AES_NI, @function
 
e9_DecryptCBC_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size e9_DecryptCBC_RIJ128pipe_AES_NI, .Lfe1-(e9_DecryptCBC_RIJ128pipe_AES_NI)
