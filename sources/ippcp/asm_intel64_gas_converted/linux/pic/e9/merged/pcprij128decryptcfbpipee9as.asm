...
.globl e9_DecryptCFB_RIJ128pipe_AES_NI
.type e9_DecryptCFB_RIJ128pipe_AES_NI, @function
 
e9_DecryptCFB_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size e9_DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(e9_DecryptCFB_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl e9_DecryptCFB32_RIJ128pipe_AES_NI
.type e9_DecryptCFB32_RIJ128pipe_AES_NI, @function
 
e9_DecryptCFB32_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size e9_DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(e9_DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl e9_DecryptCFB128_RIJ128pipe_AES_NI
.type e9_DecryptCFB128_RIJ128pipe_AES_NI, @function
 
e9_DecryptCFB128_RIJ128pipe_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe3:
.size e9_DecryptCFB128_RIJ128pipe_AES_NI, .Lfe3-(e9_DecryptCFB128_RIJ128pipe_AES_NI)
