...
.globl e9_cpAESDecryptXTS_AES_NI
.type e9_cpAESDecryptXTS_AES_NI, @function
 
e9_cpAESDecryptXTS_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size e9_cpAESDecryptXTS_AES_NI, .Lfe1-(e9_cpAESDecryptXTS_AES_NI)
