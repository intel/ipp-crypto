...
.globl k0_cpAESEncryptXTS_AES_NI
.type k0_cpAESEncryptXTS_AES_NI, @function
 
k0_cpAESEncryptXTS_AES_NI:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_cpAESEncryptXTS_AES_NI, .Lfe1-(k0_cpAESEncryptXTS_AES_NI)
