...
.globl k0_AesGcmPrecompute_avx
.type k0_AesGcmPrecompute_avx, @function
 
k0_AesGcmPrecompute_avx:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_AesGcmPrecompute_avx, .Lfe1-(k0_AesGcmPrecompute_avx)
.p2align 6, 0x90
 
.globl k0_AesGcmMulGcm_avx
.type k0_AesGcmMulGcm_avx, @function
...
vzeroupper 
    ...
    ret
.Lfe2:
.size k0_AesGcmMulGcm_avx, .Lfe2-(k0_AesGcmMulGcm_avx)
.p2align 6, 0x90
 
.globl k0_AesGcmAuth_avx
.type k0_AesGcmAuth_avx, @function
...
vzeroupper 
    ...
    ret
.Lfe3:
.size k0_AesGcmAuth_avx, .Lfe3-(k0_AesGcmAuth_avx)
.p2align 6, 0x90
 
.globl k0_AesGcmEnc_avx
.type k0_AesGcmEnc_avx, @function
...
vzeroupper 
    ...
    ret
.Lfe4:
.size k0_AesGcmEnc_avx, .Lfe4-(k0_AesGcmEnc_avx)
.p2align 6, 0x90
 
.globl k0_AesGcmDec_avx
.type k0_AesGcmDec_avx, @function
...
vzeroupper 
    ...
    ret
.Lfe5:
.size k0_AesGcmDec_avx, .Lfe5-(k0_AesGcmDec_avx)
