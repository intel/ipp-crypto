...
.globl k0_TransformNative2Composite
.type k0_TransformNative2Composite, @function
 
k0_TransformNative2Composite:
...
vzeroupper 
    ...
    ret
.Lfe1:
.size k0_TransformNative2Composite, .Lfe1-(k0_TransformNative2Composite)
.p2align 6, 0x90
 
.globl k0_SafeEncrypt_RIJ128
.type k0_SafeEncrypt_RIJ128, @function
 
k0_SafeEncrypt_RIJ128:
...
vzeroupper 
    ...
    ret
.Lfe2:
.size k0_SafeEncrypt_RIJ128, .Lfe2-(k0_SafeEncrypt_RIJ128)
