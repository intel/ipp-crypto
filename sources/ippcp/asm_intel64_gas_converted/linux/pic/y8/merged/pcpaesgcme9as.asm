...
.globl y8_AesGcmPrecompute_avx
.type y8_AesGcmPrecompute_avx, @function
 
y8_AesGcmPrecompute_avx:
    ...
    ret
.Lfe1:
.size y8_AesGcmPrecompute_avx, .Lfe1-(y8_AesGcmPrecompute_avx)
.p2align 4, 0x90
 
.globl y8_AesGcmMulGcm_avx
.type y8_AesGcmMulGcm_avx, @function
...
y8_AesGcmMulGcm_avx:
    ...
    ret
.Lfe2:
.size y8_AesGcmMulGcm_avx, .Lfe2-(y8_AesGcmMulGcm_avx)
.p2align 4, 0x90
 
.globl y8_AesGcmAuth_avx
.type y8_AesGcmAuth_avx, @function
...
.Lauth_loopgas_3: 
    ...
    ret
.Lfe3:
.size y8_AesGcmAuth_avx, .Lfe3-(y8_AesGcmAuth_avx)
.p2align 4, 0x90
 
.globl y8_AesGcmEnc_avx
.type y8_AesGcmEnc_avx, @function
...
.Lquitgas_4: 
    ...
    ret
.Lfe4:
.size y8_AesGcmEnc_avx, .Lfe4-(y8_AesGcmEnc_avx)
.p2align 4, 0x90
 
.globl y8_AesGcmDec_avx
.type y8_AesGcmDec_avx, @function
...
.Lquitgas_5: 
    ...
    ret
.Lfe5:
.size y8_AesGcmDec_avx, .Lfe5-(y8_AesGcmDec_avx)
