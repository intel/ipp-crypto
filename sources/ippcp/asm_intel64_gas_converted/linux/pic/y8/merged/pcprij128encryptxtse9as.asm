...
.globl y8_cpAESEncryptXTS_AES_NI
.type y8_cpAESEncryptXTS_AES_NI, @function
 
y8_cpAESEncryptXTS_AES_NI:
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size y8_cpAESEncryptXTS_AES_NI, .Lfe1-(y8_cpAESEncryptXTS_AES_NI)
