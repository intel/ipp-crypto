...
.globl l9_cpSqr_avx2_V0
.type l9_cpSqr_avx2_V0, @function
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_cpSqr_avx2_V0, .Lfe1-(l9_cpSqr_avx2_V0)
.p2align 5, 0x90
 
.globl l9_cpSqr_avx2
.type l9_cpSqr_avx2, @function
...
vzeroupper 
    ...
    ret
.Lfe2:
.size l9_cpSqr_avx2, .Lfe2-(l9_cpSqr_avx2)
.p2align 5, 0x90
 
.globl l9_cpMontRed_avx2
.type l9_cpMontRed_avx2, @function
...
vzeroupper 
    ...
    ret
.Lfe3:
.size l9_cpMontRed_avx2, .Lfe3-(l9_cpMontRed_avx2)
