...
.globl l9_EncryptECB_RIJ128pipe_AES_NI
.type l9_EncryptECB_RIJ128pipe_AES_NI, @function
...
vzeroupper 
    ...
    ret
.Lfe1:
.size l9_EncryptECB_RIJ128pipe_AES_NI, .Lfe1-(l9_EncryptECB_RIJ128pipe_AES_NI)
