...
.Lmla_enrtygas_1: 
    ...
    ret
.Lfe1:
.size mul_8Nx8M_adcox, .Lfe1-(mul_8Nx8M_adcox)
.p2align 4, 0x90
mla_simple: 
    xor          %rax, %rax
    mov          %rdx, %r11
...
.Lquitgas_2: 
    ...
    ret
.Lfe2:
.size mul_NxM_adcox, .Lfe2-(mul_NxM_adcox)
...
.Lupdate_Trianglegas_3: 
    ...
    ret
.Lfe3:
.size sqr_8N_adcox, .Lfe3-(sqr_8N_adcox)
.p2align 4, 0x90
...
.Lquitgas_4: 
    ret
.Lfe4:
.size sqr_N_adcox, .Lfe4-(sqr_N_adcox)
...
.LentryInnerLoopgas_5: 
    ...
    ret
.Lfe5:
.size mred_8N_adcox, .Lfe5-(mred_8N_adcox)
.p2align 4, 0x90
...
.Lcomplete_reductiongas_6: 
    ...
    ret
.Lfe6:
.size mred_N_adcox, .Lfe6-(mred_N_adcox)
 
.p2align 5, 0x90
 
.globl l9_cpMulAdx_BNU_school
.type l9_cpMulAdx_BNU_school, @function
 
l9_cpMulAdx_BNU_school:
...
vzeroupper 
    ...
    ret
.Lfe7:
.size l9_cpMulAdx_BNU_school, .Lfe7-(l9_cpMulAdx_BNU_school)
.p2align 5, 0x90
 
.globl l9_cpSqrAdx_BNU_school
.type l9_cpSqrAdx_BNU_school, @function
 
l9_cpSqrAdx_BNU_school:
...
vzeroupper 
    ...
    ret
.Lfe8:
.size l9_cpSqrAdx_BNU_school, .Lfe8-(l9_cpSqrAdx_BNU_school)
.p2align 5, 0x90
 
.globl l9_cpMontRedAdx_BNU
.type l9_cpMontRedAdx_BNU, @function
...
vzeroupper 
    ...
    ret
.Lfe9:
.size l9_cpMontRedAdx_BNU, .Lfe9-(l9_cpMontRedAdx_BNU)
