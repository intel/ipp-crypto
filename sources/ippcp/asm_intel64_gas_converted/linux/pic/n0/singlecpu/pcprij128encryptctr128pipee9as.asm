...
.globl EncryptStreamCTR32_AES_NI
.type EncryptStreamCTR32_AES_NI, @function
 
EncryptStreamCTR32_AES_NI:
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size EncryptStreamCTR32_AES_NI, .Lfe1-(EncryptStreamCTR32_AES_NI)
