...
.globl cpMulAdx_BNU_school
.type cpMulAdx_BNU_school, @function
...
.Lquitgas_7: 
    ...
    ret
.Lfe7:
.size cpMulAdx_BNU_school, .Lfe7-(cpMulAdx_BNU_school)
.p2align 6, 0x90
 
.globl cpSqrAdx_BNU_school
.type cpSqrAdx_BNU_school, @function
...
.Lquitgas_8: 
    ...
    ret
.Lfe8:
.size cpSqrAdx_BNU_school, .Lfe8-(cpSqrAdx_BNU_school)
.p2align 6, 0x90
 
.globl cpMontRedAdx_BNU
.type cpMontRedAdx_BNU, @function
...
.Lquitgas_9: 
    ...
    ret
.Lfe9:
.size cpMontRedAdx_BNU, .Lfe9-(cpMontRedAdx_BNU)
