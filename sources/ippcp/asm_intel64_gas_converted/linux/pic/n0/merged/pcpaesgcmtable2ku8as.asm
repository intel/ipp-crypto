...
.globl n0_AesGcmMulGcm_table2K
.type n0_AesGcmMulGcm_table2K, @function
 
n0_AesGcmMulGcm_table2K:
    ...
    ret
.Lfe1:
.size n0_AesGcmMulGcm_table2K, .Lfe1-(n0_AesGcmMulGcm_table2K)
.p2align 6, 0x90
 
.globl n0_AesGcmAuth_table2K
.type n0_AesGcmAuth_table2K, @function
 
n0_AesGcmAuth_table2K:
...
.Lauth_loopgas_2: 
    ...
    ret
.Lfe2:
.size n0_AesGcmAuth_table2K, .Lfe2-(n0_AesGcmAuth_table2K)
