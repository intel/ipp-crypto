...
typedef struct _cpGFpEC {
   ...
   cpModulusID  idModulus; /* Modulus type */
...
#define ECP_MODULUS_ID(pCtx)  ((pCtx)->idModulus)
...
#define gfpec_precom_nistP256r1_radix52_fun OWNAPI(gfpec_precom_nistP256r1_radix52_fun)
...
IPP_OWN_DECL (const cpPrecompAP*, gfpec_precom_nistP256r1_radix52_fun, (void))
...
#define gfec_point_on_curve_nistp256_avx512 OWNAPI(gfec_point_on_curve_nistp256_avx512)
#define gfec_point_on_curve_nistp384_avx512 OWNAPI(gfec_point_on_curve_nistp384_avx512)
#define gfec_point_on_curve_nistp521_avx512 OWNAPI(gfec_point_on_curve_nistp521_avx512)
#define gfec_point_on_curve_sm2_avx512      OWNAPI(gfec_point_on_curve_sm2_avx512)
...
IPP_OWN_DECL (int, gfec_point_on_curve_nistp256_avx512, (const IppsGFpECPoint *pPoint, IppsGFpECState *pEC))
IPP_OWN_DECL (int, gfec_point_on_curve_nistp384_avx512, (const IppsGFpECPoint *pPoint, IppsGFpECState *pEC))
IPP_OWN_DECL (int, gfec_point_on_curve_nistp521_avx512, (const IppsGFpECPoint *pPoint, IppsGFpECState *pEC))
IPP_OWN_DECL (int, gfec_point_on_curve_sm2_avx512,      (const IppsGFpECPoint *pPoint, IppsGFpECState *pEC))
