...
{
   __m256i IV = _mm256_castsi128_si256(_mm_loadu_si128((__m128i*)(pIV)));
   ...
   for(n=0; n<processedLen; n+=(24*MBS_SMS4), pInp+=(24*MBS_SMS4), pOut+=(24*MBS_SMS4)) {
      ...
      T2 = _mm256_shuffle_epi8(T2, M256(swapBytes));
      T3 = _mm256_shuffle_epi8(T3, M256(swapBytes));
      K0 = _mm256_xor_si256(T0, _mm256_inserti128_si256(IV, _mm_loadu_si128((__m128i*)(pInp)), 1));
      K1 = _mm256_xor_si256(T1, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4)));
      K2 = _mm256_xor_si256(T2, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*3)));
      K3 = _mm256_xor_si256(T3, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*5)));
      ...
      T2 = _mm256_shuffle_epi8(T2, M256(swapBytes));
      T3 = _mm256_shuffle_epi8(T3, M256(swapBytes));
      P0 = _mm256_xor_si256(T0, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*7)));
      P1 = _mm256_xor_si256(T1, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*9)));
      P2 = _mm256_xor_si256(T2, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*11)));
      P3 = _mm256_xor_si256(T3, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*13)));
      ...
      T2 = _mm256_shuffle_epi8(T2, M256(swapBytes));
      T3 = _mm256_shuffle_epi8(T3, M256(swapBytes));
      Q0 = _mm256_xor_si256(T0, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*15)));
      Q1 = _mm256_xor_si256(T1, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*17)));
      Q2 = _mm256_xor_si256(T2, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*19)));
      Q3 = _mm256_xor_si256(T3, _mm256_loadu_si256((__m256i*)(pInp+MBS_SMS4*21)));

      IV = _mm256_castsi128_si256(_mm_loadu_si128((__m128i*)(pInp+MBS_SMS4*23)));

      _mm256_storeu_si256((__m256i*)(pOut),            K0);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*2), K1);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*4), K2);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*6), K3);

      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*8),  P0);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*10), P1);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*12), P2);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*14), P3);

      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*16), Q0);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*18), Q1);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*20), Q2);
      _mm256_storeu_si256((__m256i*)(pOut+MBS_SMS4*22), Q3);
   }

   _mm_storeu_si128((__m128i*)(pIV), _mm256_castsi256_si128(IV));
