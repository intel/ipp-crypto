...
.select_loop:
      ...
      movdqa   xmm1, xmm4
      pand     xmm1, oword [esi+sizeof(oword)]
      por      xmm1, oword [edi+sizeof(oword)]
      movdqa   oword [edi+sizeof(oword)], xmm1
      movdqa   xmm2, xmm4
      pand     xmm2, oword [esi+sizeof(oword)*2]
      por      xmm2, oword [edi+sizeof(oword)*2]
      movdqa   oword [edi+sizeof(oword)*2], xmm2

      movdqa   xmm0, xmm4
      pand     xmm0, oword [esi+sizeof(oword)*3]
      por      xmm0, oword [edi+sizeof(oword)*3]
      movdqa   oword [edi+sizeof(oword)*3], xmm0
      movdqa   xmm1, xmm4
      pand     xmm1, oword [esi+sizeof(oword)*4]
      por      xmm1, oword [edi+sizeof(oword)*4]
      movdqa   oword [edi+sizeof(oword)*4], xmm1
      movdqa   xmm2, xmm4
      pand     xmm2, oword [esi+sizeof(oword)*5]
      por      xmm2, oword [edi+sizeof(oword)*5]
      movdqa   oword [edi+sizeof(oword)*5], xmm2

      movdqa   xmm0, xmm4
      pand     xmm0, oword [esi+sizeof(oword)*6]
      por      xmm0, oword [edi+sizeof(oword)*6]
      movdqa   oword [edi+sizeof(oword)*6], xmm0
      movdqa   xmm1, xmm4
      pand     xmm1, oword [esi+sizeof(oword)*7]
      por      xmm1, oword [edi+sizeof(oword)*7]
      movdqa   oword [edi+sizeof(oword)*7], xmm1
      movdqa   xmm2, xmm4
      pand     xmm2, oword [esi+sizeof(oword)*8]
      por      xmm2, oword [edi+sizeof(oword)*8]
      movdqa   oword [edi+sizeof(oword)*8], xmm2
