...
/*F*
//    Name: ippsAES_CMACSetupNoise
//
// Purpose: AES-CMAC Setup Noise
//
// Returns:                Reason:
...
//
*F*/
IPPFUN(IppStatus, ippsAES_CMACSetupNoise,(Ipp32u noiseLevel, IppsAES_CMACState* pState))
{
