...
//
//  Contents:
//        ippsHashStateMethodSet_SHA224_NI()
//
*/
...
/*F*
//    Name: ippsHashStateMethodSet_SHA224_NI
//
// Purpose: Setup SHA224 method inside the hash state (using the Intel® Secure Hash Algorithm - New Instructions (Intel® SHA-NI) instruction set).
//
// Returns:                Reason:
...
IPPFUN( IppStatus, ippsHashStateMethodSet_SHA224_NI, (IppsHashState_rmf* pState, IppsHashMethod* pMethod) )
{
   /* test pointers */
