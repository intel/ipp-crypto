...
.globl _p8_DecryptCFB_RIJ128pipe_AES_NI

 
_p8_DecryptCFB_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _p8_DecryptCFB32_RIJ128pipe_AES_NI

 
_p8_DecryptCFB32_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _p8_DecryptCFB128_RIJ128pipe_AES_NI

 
_p8_DecryptCFB128_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
