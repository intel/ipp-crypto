...
.globl _p8_sm2_mul_mont_slm

 
_p8_sm2_mul_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _p8_sm2_sqr_mont_slm

 
_p8_sm2_sqr_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.globl _p8_sm2_select_pp_w5

 
_p8_sm2_select_pp_w5:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.globl _p8_sm2_select_ap_w7

 
_p8_sm2_select_ap_w7:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
