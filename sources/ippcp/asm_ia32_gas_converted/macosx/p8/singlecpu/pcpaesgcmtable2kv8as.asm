...
.globl _getAesGcmConst_table_ct

 
_getAesGcmConst_table_ct:
    push         %ebx
    call         .L__0000gas_1
.L__0000gas_1:
    pop          %ebx
...
.globl _AesGcmMulGcm_table2K

 
_AesGcmMulGcm_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
