...
.globl _h9_p192r1_mul_mont_slm

 
_h9_p192r1_mul_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _h9_p192r1_sqr_mont_slm

 
_h9_p192r1_sqr_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.globl _h9_p192r1_select_pp_w5

 
_h9_p192r1_select_pp_w5:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
