...
.globl _h9_DecryptCFB_RIJ128pipe_AES_NI

 
_h9_DecryptCFB_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _h9_DecryptCFB32_RIJ128pipe_AES_NI

 
_h9_DecryptCFB32_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _h9_DecryptCFB128_RIJ128pipe_AES_NI

 
_h9_DecryptCFB128_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
