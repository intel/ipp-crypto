...
.globl _g9_p224r1_mul_mont_slm

 
_g9_p224r1_mul_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.globl _g9_p224r1_sqr_mont_slm

 
_g9_p224r1_sqr_mont_slm:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.globl _g9_p224r1_select_pp_w5

 
_g9_p224r1_select_pp_w5:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
