...
.globl _g9_getAesGcmConst_table_ct

 
_g9_getAesGcmConst_table_ct:
    push         %ebx
    call         .L__0000gas_1
.L__0000gas_1:
    pop          %ebx
...
.globl _g9_AesGcmMulGcm_table2K

 
_g9_AesGcmMulGcm_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
    ...
    psrldq       $(15), %xmm0
    movd         %xmm0, %ecx
    call         _g9_getAesGcmConst_table_ct
    shl          $(8), %eax
    movdqa       %xmm5, %xmm0
    pslldq       $(1), %xmm5
    pxor         %xmm5, %xmm4
...
.globl _g9_AesGcmAuth_table2K

 
_g9_AesGcmAuth_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
