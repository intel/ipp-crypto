...
.globl s8_getAesGcmConst_table_ct
.type s8_getAesGcmConst_table_ct, @function
 
s8_getAesGcmConst_table_ct:
    push         %ebx
    call         .L__0000gas_1
.L__0000gas_1:
    pop          %ebx
...
.Lsearch_loopgas_1: 
    ...
    ret
.Lfe1:
.size s8_getAesGcmConst_table_ct, .Lfe1-(s8_getAesGcmConst_table_ct)
.p2align 4, 0x90
 
.globl s8_AesGcmMulGcm_table2K
.type s8_AesGcmMulGcm_table2K, @function
 
s8_AesGcmMulGcm_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
    ...
    psrldq       $(15), %xmm0
    movd         %xmm0, %ecx
    call         s8_getAesGcmConst_table_ct
    shl          $(8), %eax
    movdqa       %xmm5, %xmm0
    pslldq       $(1), %xmm5
    pxor         %xmm5, %xmm4
    ...
    ret
.Lfe2:
.size s8_AesGcmMulGcm_table2K, .Lfe2-(s8_AesGcmMulGcm_table2K)
.p2align 4, 0x90
 
.globl s8_AesGcmAuth_table2K
.type s8_AesGcmAuth_table2K, @function
 
s8_AesGcmAuth_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lauth_loopgas_3: 
    ...
    ret
.Lfe3:
.size s8_AesGcmAuth_table2K, .Lfe3-(s8_AesGcmAuth_table2K)
