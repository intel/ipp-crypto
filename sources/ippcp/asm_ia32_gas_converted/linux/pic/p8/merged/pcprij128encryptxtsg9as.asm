...
.globl p8_cpAESEncryptXTS_AES_NI
.type p8_cpAESEncryptXTS_AES_NI, @function
 
p8_cpAESEncryptXTS_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size p8_cpAESEncryptXTS_AES_NI, .Lfe1-(p8_cpAESEncryptXTS_AES_NI)
