...
.globl g9_TransformNative2Composite
.type g9_TransformNative2Composite, @function
 
g9_TransformNative2Composite:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.L__0000gas_1:
    ...
    ret
.Lfe1:
.size g9_TransformNative2Composite, .Lfe1-(g9_TransformNative2Composite)
.p2align 5, 0x90
 
.globl g9_SafeDecrypt_RIJ128
.type g9_SafeDecrypt_RIJ128, @function
 
g9_SafeDecrypt_RIJ128:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.Ldecode_roundgas_2: 
    ...
    ret
.Lfe2:
.size g9_SafeDecrypt_RIJ128, .Lfe2-(g9_SafeDecrypt_RIJ128)
