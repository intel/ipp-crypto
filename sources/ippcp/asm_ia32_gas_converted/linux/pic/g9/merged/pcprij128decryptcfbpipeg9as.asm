...
.globl g9_DecryptCFB_RIJ128pipe_AES_NI
.type g9_DecryptCFB_RIJ128pipe_AES_NI, @function
 
g9_DecryptCFB_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size g9_DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(g9_DecryptCFB_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl g9_DecryptCFB32_RIJ128pipe_AES_NI
.type g9_DecryptCFB32_RIJ128pipe_AES_NI, @function
 
g9_DecryptCFB32_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_2: 
    ...
    ret
.Lfe2:
.size g9_DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(g9_DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl g9_DecryptCFB128_RIJ128pipe_AES_NI
.type g9_DecryptCFB128_RIJ128pipe_AES_NI, @function
 
g9_DecryptCFB128_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_3: 
    ...
    ret
.Lfe3:
.size g9_DecryptCFB128_RIJ128pipe_AES_NI, .Lfe3-(g9_DecryptCFB128_RIJ128pipe_AES_NI)
