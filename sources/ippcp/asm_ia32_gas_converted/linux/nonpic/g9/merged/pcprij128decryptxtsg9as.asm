...
.globl g9_cpAESDecryptXTS_AES_NI
.type g9_cpAESDecryptXTS_AES_NI, @function
 
g9_cpAESDecryptXTS_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size g9_cpAESDecryptXTS_AES_NI, .Lfe1-(g9_cpAESDecryptXTS_AES_NI)
