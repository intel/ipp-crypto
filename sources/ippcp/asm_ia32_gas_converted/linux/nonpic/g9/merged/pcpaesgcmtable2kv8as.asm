...
.globl g9_getAesGcmConst_table_ct
.type g9_getAesGcmConst_table_ct, @function
 
g9_getAesGcmConst_table_ct:
    push         %ebx
    lea          _CONST_DATA, %ebx
    pxor         %xmm2, %xmm2
    mov          %ecx, %eax
...
.Lsearch_loopgas_1: 
    ...
    ret
.Lfe1:
.size g9_getAesGcmConst_table_ct, .Lfe1-(g9_getAesGcmConst_table_ct)
.p2align 5, 0x90
 
.globl g9_AesGcmMulGcm_table2K
.type g9_AesGcmMulGcm_table2K, @function
 
g9_AesGcmMulGcm_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
    ...
    psrldq       $(15), %xmm0
    movd         %xmm0, %ecx
    call         g9_getAesGcmConst_table_ct
    shl          $(8), %eax
    movdqa       %xmm5, %xmm0
    pslldq       $(1), %xmm5
    pxor         %xmm5, %xmm4
    ...
    ret
.Lfe2:
.size g9_AesGcmMulGcm_table2K, .Lfe2-(g9_AesGcmMulGcm_table2K)
.p2align 5, 0x90
 
.globl g9_AesGcmAuth_table2K
.type g9_AesGcmAuth_table2K, @function
 
g9_AesGcmAuth_table2K:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lauth_loopgas_3: 
    ...
    ret
.Lfe3:
.size g9_AesGcmAuth_table2K, .Lfe3-(g9_AesGcmAuth_table2K)
