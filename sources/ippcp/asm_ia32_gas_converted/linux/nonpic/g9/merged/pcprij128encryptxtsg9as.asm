...
.globl g9_cpAESEncryptXTS_AES_NI
.type g9_cpAESEncryptXTS_AES_NI, @function
 
g9_cpAESEncryptXTS_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size g9_cpAESEncryptXTS_AES_NI, .Lfe1-(g9_cpAESEncryptXTS_AES_NI)
