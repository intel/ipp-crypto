...
.globl p8_TransformNative2Composite
.type p8_TransformNative2Composite, @function
 
p8_TransformNative2Composite:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
    ...
    ret
.Lfe1:
.size p8_TransformNative2Composite, .Lfe1-(p8_TransformNative2Composite)
.p2align 4, 0x90
 
.globl p8_SafeDecrypt_RIJ128
.type p8_SafeDecrypt_RIJ128, @function
 
p8_SafeDecrypt_RIJ128:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.Ldecode_roundgas_2: 
    ...
    ret
.Lfe2:
.size p8_SafeDecrypt_RIJ128, .Lfe2-(p8_SafeDecrypt_RIJ128)
