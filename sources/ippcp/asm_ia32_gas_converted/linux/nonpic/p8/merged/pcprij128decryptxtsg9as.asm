...
.globl p8_cpAESDecryptXTS_AES_NI
.type p8_cpAESDecryptXTS_AES_NI, @function
 
p8_cpAESDecryptXTS_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size p8_cpAESDecryptXTS_AES_NI, .Lfe1-(p8_cpAESDecryptXTS_AES_NI)
