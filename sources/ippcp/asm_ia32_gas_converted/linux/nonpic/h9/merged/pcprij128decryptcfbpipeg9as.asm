...
.globl h9_DecryptCFB_RIJ128pipe_AES_NI
.type h9_DecryptCFB_RIJ128pipe_AES_NI, @function
 
h9_DecryptCFB_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size h9_DecryptCFB_RIJ128pipe_AES_NI, .Lfe1-(h9_DecryptCFB_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl h9_DecryptCFB32_RIJ128pipe_AES_NI
.type h9_DecryptCFB32_RIJ128pipe_AES_NI, @function
 
h9_DecryptCFB32_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_2: 
    ...
    ret
.Lfe2:
.size h9_DecryptCFB32_RIJ128pipe_AES_NI, .Lfe2-(h9_DecryptCFB32_RIJ128pipe_AES_NI)
.p2align 5, 0x90
 
.globl h9_DecryptCFB128_RIJ128pipe_AES_NI
.type h9_DecryptCFB128_RIJ128pipe_AES_NI, @function
 
h9_DecryptCFB128_RIJ128pipe_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
