...
.globl h9_cpAESEncryptXTS_AES_NI
.type h9_cpAESEncryptXTS_AES_NI, @function
 
h9_cpAESEncryptXTS_AES_NI:
    push         %ebp
    mov          %esp, %ebp
    push         %ebx
    push         %esi
...
.Lquitgas_1: 
    ...
    ret
.Lfe1:
.size h9_cpAESEncryptXTS_AES_NI, .Lfe1-(h9_cpAESEncryptXTS_AES_NI)
