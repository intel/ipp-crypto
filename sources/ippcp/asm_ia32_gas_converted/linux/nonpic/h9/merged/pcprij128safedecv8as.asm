...
.globl h9_TransformNative2Composite
.type h9_TransformNative2Composite, @function
 
h9_TransformNative2Composite:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
    ...
    ret
.Lfe1:
.size h9_TransformNative2Composite, .Lfe1-(h9_TransformNative2Composite)
.p2align 5, 0x90
 
.globl h9_SafeDecrypt_RIJ128
.type h9_SafeDecrypt_RIJ128, @function
 
h9_SafeDecrypt_RIJ128:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.Ldecode_roundgas_2: 
    ...
    ret
.Lfe2:
.size h9_SafeDecrypt_RIJ128, .Lfe2-(h9_SafeDecrypt_RIJ128)
