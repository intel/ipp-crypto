...
.globl s8_TransformNative2Composite
.type s8_TransformNative2Composite, @function
 
s8_TransformNative2Composite:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
    ...
    ret
.Lfe1:
.size s8_TransformNative2Composite, .Lfe1-(s8_TransformNative2Composite)
.p2align 4, 0x90
 
.globl s8_SafeDecrypt_RIJ128
.type s8_SafeDecrypt_RIJ128, @function
 
s8_SafeDecrypt_RIJ128:
    push         %ebp
    mov          %esp, %ebp
    push         %esi
    push         %edi
...
.Ldecode_roundgas_2: 
    ...
    ret
.Lfe2:
.size s8_SafeDecrypt_RIJ128, .Lfe2-(s8_SafeDecrypt_RIJ128)
