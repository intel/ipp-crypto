...
static int ssl_test_ifma_rsa(int rsaBitsize, int flag)
{
   int ret = 1;
   int slot, ntest;
   ...
   for(ntest=0; ntest<10/*1000*/ && ret; ntest++) {
      ...
      if(ret) {
         // ifma rsa
         memset(ifma_encbuf_mb8, 0, sizeof(ifma_encbuf_mb8));
         ifma_rsa52_public_mb8((const int8u **)ifma_ptxt_mb8, ifma_enc_mb8,
                               e_mb8, n_mb8,
                               rsaBitsize);
         // comparison
      ...
      if (ret && (flag & RSA_DEC2)) {
         memset(ifma_decbuf_mb8, 0, sizeof(ifma_decbuf_mb8));
         ifma_rsa52_private_mb8((const int8u **)ifma_enc_mb8, ifma_dec_mb8,
                                d_mb8, n_mb8,
                                rsaBitsize);
         // comparison
      ...
      if (ret && (flag & RSA_DEC5)) {
         memset(ifma_decbuf_mb8, 0, sizeof(ifma_decbuf_mb8));
         ifma_rsa52_private_crt_mb8((const int8u **)ifma_enc_mb8, ifma_dec_mb8,
                                    p_mb8, q_mb8,
...
int main(void)
{
   ...
   //////////////////////////////////////////////////////////////
   printf("ifma_rsa52_mb8(1024):\n");
   if (0 == ssl_test_ifma_rsa(1024, RSA_ENC|RSA_DEC2|RSA_DEC5)) printf("failed\n");
   else printf("passed\n");

   printf("ifma_rsa52_mb8(2048):\n");
   if (0 == ssl_test_ifma_rsa(2048, RSA_ENC|RSA_DEC2|RSA_DEC5)) printf("failed\n");
   else printf("passed\n");

   printf("ifma_rsa52_mb8(3072):\n");
   if (0 == ssl_test_ifma_rsa(3072, RSA_ENC|RSA_DEC2|RSA_DEC5)) printf("failed\n");
   else printf("passed\n");

   printf("ifma_rsa52_mb8(4096):\n");
   if (0 == ssl_test_ifma_rsa(4096, RSA_ENC|RSA_DEC2|RSA_DEC5)) printf("failed\n");
   else printf("passed\n");
