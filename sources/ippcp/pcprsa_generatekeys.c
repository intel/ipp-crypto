...

        {
            ...
            */
            ...
            for (r = 0, found = 0; r < nRounds && !found; r++) {
                ...
                if (0 == cpIsCoPrime(BN_NUMBER(pPublicExp),
                                     BN_SIZE(pPublicExp),
                                     pFactorP,
                                     nsP,
                                     pFreeBuffer))
                ...
                //found = 1;
                ret = cpIsProbablyPrime(pFactorP,
                                        factorPbitSize,
                                        mrTrials,
                                        rndFunc,
                                        pRndParam,
            ...
            */
            ...
            for (r = 0, found = 0; r < nRounds && !found; r++) {
                ...
                if (factorPbitSize == factorQbitSize) {
                    ...
                    if (0 == cmp_res)
                        ...
                        if (factorPbitSize >= 512) {
                            ...
                            if (bitsize < (factorPbitSize - 100))
                                continue; /* abs(P-Q) <=2^(factorPbitSize-100)*/
                        }
                    }
                }
                ...
                if (rsaModulusBitSize != BITSIZE_BNU(pProdN, nsN))
                    continue;
                ...
                //found = 1;
                ret = cpIsProbablyPrime(pFactorQ,
                                        factorQbitSize,
                                        mrTrials,
                                        rndFunc,
                                        pRndParam,
