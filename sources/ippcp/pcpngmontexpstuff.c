   ...
   */
   ...
   /* general case */
      ...
      /* exponentiation */
      {
         ...
         /* initialize result */
         COPY_BNU(dataY, pTable+winVal*nsM, nsM);
         ...
         for(eBit-=winSize; eBit>=0; eBit-=winSize) {
            ...
            MOD_METHOD( pMont )->mul(dataY, dataY, pTable+winVal*nsM, pMont);
         }
   ...
   */
   ...
   /* general case */
      ...
      /* exponentiation */
      {
         ...
         /* initialize result */
         gsScrambleGet_sscm(dataY, nsM, pTable, winVal, winSize);
         ...
         for(eBit-=winSize; eBit>=0; eBit-=winSize) {
            ...
            gsScrambleGet_sscm(dataTT, nsM, pTable, winVal, winSize);
