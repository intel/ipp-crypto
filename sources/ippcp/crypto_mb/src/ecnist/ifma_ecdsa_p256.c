                                              ...
                                              int8u* pBuffer)
{
   ...
   U64 T[P256_LEN52];
   ifma_BNU_to_mb8((int64u (*)[8])T, pa_skey, P256_BITSIZE);
                                                  ...
                                                  int8u* pBuffer)
{
   ...
   /* convert keys into FE and compute inversion */
   U64 T[P256_LEN52];
   ifma_BN_to_mb8((int64u (*)[])T, pa_skey, P256_BITSIZE);
   nistp256_ecdsa_inv_keys_mb8(T, T, 0);
   /* store results in suitable format */
   ifma_mb8_to_BN_256(pa_inv_skey, (const int64u (*)[])T);
   ...
   /* convert keys into scalars */
   U64 scalarz[P256_LEN64+1];
   ifma_BN_transpose_copy((int64u (*)[])scalarz, pa_skey, P256_BITSIZE);
   scalarz[P256_LEN64] = get_zero64();
   /* compute r-component of the DSA signature */
   int8u stt_mask = nistp256_ecdsa_sign_r_mb8(T, scalarz, pBuffer);
   ...
   /* store results in suitable format */
   ifma_mb8_to_BN_256(pa_sign_rp, (const int64u (*)[])T);
                                                    ...
                                                    int8u* pBuffer)
{
   ...
   /* convert inv_eph, reg_skey and sign_r to mb format */
   ifma_BN_to_mb8((int64u (*)[])inv_eph, pa_inv_eph_skey, P256_BITSIZE);
   ifma_BN_to_mb8((int64u (*)[])reg_skey, pa_reg_skey, P256_BITSIZE);
   ifma_BN_to_mb8((int64u (*)[])sign_r, pa_sign_rp, P256_BITSIZE);
                                           ...
                                           int8u* pBuffer)
{
   ...
   /* convert ephemeral keys into FE and compute inversion */
   ifma_BN_to_mb8((int64u (*)[])inv_eph_key, pa_eph_skey, P256_BITSIZE);
   nistp256_ecdsa_inv_keys_mb8(inv_eph_key, inv_eph_key, pBuffer);

   /* convert epphemeral keys into sclar and compute sign_r */
   ifma_BN_transpose_copy((int64u (*)[])scalar, pa_eph_skey, P256_BITSIZE);
   scalar[P256_LEN64] = get_zero64();
   nistp256_ecdsa_sign_r_mb8(sign_r, scalar, pBuffer);

   /* convert reg_skey and compute s-component */
   ifma_BN_to_mb8((int64u (*)[])reg_key, pa_reg_skey, P256_BITSIZE);
   nistp256_ecdsa_sign_s_mb8(sign_s, pa_msg, sign_r, inv_eph_key, reg_key, pBuffer);
