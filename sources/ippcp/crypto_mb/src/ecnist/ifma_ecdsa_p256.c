                                         ...
                                         int8u* pBuffer)
{
   ...
   //MB_FUNC_NAME(ifma_sub52_n256_)(sign_r, P.X, MB_FUNC_NAME(ifma_n256_)()); /* fast reduction */
                                   ...
                                   P256_POINT* W)
{
   ...
   MB_FUNC_NAME(get_nistp256_ec_projective_coords_)(sign_r_restored, NULL, &P);
                                                ...
                                                int8u* pBuffer)
{
   ...
   nistp256_ecdsa_sign_s_mb8(sign_s, pa_msg, sign_r, inv_eph, reg_skey, pBuffer);
                                       ...
                                       int8u* pBuffer)
{
   ...
   nistp256_ecdsa_sign_s_mb8(sign_s, pa_msg, sign_r, inv_eph_key, reg_key, pBuffer);
                                               ...
                                               int8u* pBuffer)
{
   ...
   if(!MBX_IS_ANY_OK_STS(status)) return status;
   ...
   __mb_mask
   missmatch_param_err_mask  = MB_FUNC_NAME(ifma_check_range_n256_)(msg);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n256_)(sign_r); 
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n256_)(sign_s);

   status |= MBX_SET_STS_BY_MASK(status, missmatch_param_err_mask, MBX_STATUS_MISMATCH_PARAM_ERR);
   if(!MBX_IS_ANY_OK_STS(status)) return status;
   ...
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p256_)(W.X);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p256_)(W.Y);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p256_)(W.Z);
