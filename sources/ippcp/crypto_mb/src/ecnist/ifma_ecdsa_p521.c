                                   ...
                                   P521_POINT* W)
{
   ...
   MB_FUNC_NAME(get_nistp521_ec_projective_coords_)(sign_r_restored, NULL, &P);
                                                ...
                                                int8u* pBuffer)
{
   ...
   nistp521_ecdsa_sign_s_mb8(sign_s, pa_msg, sign_r, inv_eph, reg_skey, pBuffer);
                                       ...
                                       int8u* pBuffer)
{
   ...
   nistp521_ecdsa_sign_s_mb8(sign_s, pa_msg, sign_r, inv_eph_key, reg_key, pBuffer);
                                                     ...
                                                     int8u* pBuffer)
{
   ...
   __mb_mask
   missmatch_param_err_mask  = MB_FUNC_NAME(ifma_check_range_n521_)(msg);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n521_)(sign_r); 
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n521_)(sign_s);
   ...
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p521_)(W.X);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p521_)(W.Y);
   missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p521_)(W.Z);
