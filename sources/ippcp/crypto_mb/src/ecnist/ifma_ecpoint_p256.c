...
// do we need funtions
//    - set_P256_POINT_to_infinity(), 
//    - is_P256_POINT_at_infinity()
//
//    - set_P256_POINT_AFFINE_to_infinity()
//    - is_P256_POINT_AFFINE_at_infinity()
...
//    Y3= B*(A-X3) -8*Y1^4
//    Z3= 2*Y1*Z1
// are form "Elliptic & Hyperelliptic Curve Cryptography"
//
// cost: 4S+4M+9A
//
*/
...
void MB_FUNC_NAME(ifma_ec_nistp256_add_point_)(P256_POINT* r, const P256_POINT* p, const P256_POINT* q)
{
   ...
   sub(R, S2, S1);      /* R = S2-S1 */
   sub(H, U2, U1);      /* H = U2-U1 */
   //__mb_mask is_zero_R = MB_FUNC_NAME(is_zero_point_cordinate_)(R);
   //__mb_mask is_zero_H = MB_FUNC_NAME(is_zero_point_cordinate_)(H);
...
// r = 2^(5*DIGIT_SIZE) mod p256
*/
__ALIGN64 static const int64u p256_r_mb[P256_LEN52][8] = {
   {0x0000000000000010,0x0000000000000010,0x0000000000000010,0x0000000000000010,0x0000000000000010,0x0000000000000010,0x0000000000000010,0x0000000000000010},
   {0x000f000000000000,0x000f000000000000,0x000f000000000000,0x000f000000000000,0x000f000000000000,0x000f000000000000,0x000f000000000000,0x000f000000000000},
   {0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff,0x000fffffffffffff},
   {0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff,0x000ffeffffffffff},
   {0x00000000000fffff,0x00000000000fffff,0x00000000000fffff,0x00000000000fffff,0x00000000000fffff,0x00000000000fffff,0x00000000000fffff,0x00000000000fffff}
};
...
void MB_FUNC_NAME(get_nistp256_ec_projective_coords_)(U64 x[], U64 y[], const P256_POINT* P)
{
...
void MB_FUNC_NAME(ifma_ec_nistp256_mul_point_)(P256_POINT* r, const P256_POINT* p, const U64 scalar[])
{
   ...
   /*
   // compute tbl[] = [n]P, n=1,..,2^(MUL_WIN_SIZE-1):
   //
   // tbl[2*n] = tbl[2*n-1]+p
   // tbl[2*n+1] = [2]*tbl[n]
   */
...
//#include <internal/ecnist/ifma_ecprecomp7_p256.h>
//#include <internal/ecnist/ifma_ecprecomp5_p256.h>
