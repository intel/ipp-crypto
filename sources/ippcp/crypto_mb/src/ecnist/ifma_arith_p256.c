...
void MB_FUNC_NAME(ifma_ams52_p256_)(U64 r[], const U64 va[])
{
  ...
  // {r0-4) = (r5-9) -modulus and normalize
  r0 = sub64(r5, ((U64*)p256_mb)[0]);
  r1 = sub64(r6, ((U64*)p256_mb)[1]);
  r2 = sub64(r7, ((U64*)p256_mb)[2]);
  r3 = sub64(r8, ((U64*)p256_mb)[3]);
  r4 = sub64(r9, ((U64*)p256_mb)[4]);
  NORM_ASHIFTR(r, 0,1)
  NORM_ASHIFTR(r, 1,2)
  NORM_ASHIFTR(r, 2,3)
  NORM_ASHIFTR(r, 3,4)

   /* condition mov r[] = (r4>=0)? r(5 - 9) : r(0 - 4) */
  __mb_mask cmask = cmp64_mask(r4, get_zero64(), _MM_CMPINT_GE);
   r[0] = cmov_U64(r5, r0, cmask);
   r[1] = cmov_U64(r6, r1, cmask);
   r[2] = cmov_U64(r7, r2, cmask);
   r[3] = cmov_U64(r8, r3, cmask);
   r[4] = cmov_U64(r9, r4, cmask);
}
                                 ...
                                 const U64 inp0[], const U64 inp1[])
{
  ...
  // (r00 - 04) = (r05 -09) -modulus and normalize
  r00 = sub64(r05, ((U64*)p256_mb)[0]);
  r01 = sub64(r06, ((U64*)p256_mb)[1]);
  r02 = sub64(r07, ((U64*)p256_mb)[2]);
  r03 = sub64(r08, ((U64*)p256_mb)[3]);
  r04 = sub64(r09, ((U64*)p256_mb)[4]);
  NORM_ASHIFTR(r0, 0,1)
  NORM_ASHIFTR(r0, 1,2)
  NORM_ASHIFTR(r0, 2,3)
  NORM_ASHIFTR(r0, 3,4)

   /* condition mov r0[] = (r4>=0)? r(5 - 9) : r(0 - 4) */
  __mb_mask cmask = cmp64_mask(r04, get_zero64(), _MM_CMPINT_GE);
   r0[0] = cmov_U64(r05, r00, cmask);
   r0[1] = cmov_U64(r06, r01, cmask);
   r0[2] = cmov_U64(r07, r02, cmask);
   r0[3] = cmov_U64(r08, r03, cmask);
   r0[4] = cmov_U64(r09, r04, cmask);
  ...
  // (r10 - 14) = (r15 -19) -modulus and normalize
  r10 = sub64(r15, ((U64*)p256_mb)[0]);
  r11 = sub64(r16, ((U64*)p256_mb)[1]);
  r12 = sub64(r17, ((U64*)p256_mb)[2]);
  r13 = sub64(r18, ((U64*)p256_mb)[3]);
  r14 = sub64(r19, ((U64*)p256_mb)[4]);
  NORM_ASHIFTR(r1, 0,1)
  NORM_ASHIFTR(r1, 1,2)
  NORM_ASHIFTR(r1, 2,3)
  NORM_ASHIFTR(r1, 3,4)

   /* condition mov r1[] = (r4>=0)? r(5 - 9) : r(0 - 4) */
  cmask = cmp64_mask(r04, get_zero64(), _MM_CMPINT_GE);
   r1[0] = cmov_U64(r15, r10, cmask);
   r1[1] = cmov_U64(r16, r11, cmask);
   r1[2] = cmov_U64(r17, r12, cmask);
   r1[3] = cmov_U64(r18, r13, cmask);
   r1[4] = cmov_U64(r19, r14, cmask);
}
...
{
   MB_FUNC_NAME(ifma_add52x5_)(r, a, b, (U64*)p256_mb);
}

void MB_FUNC_NAME(ifma_sub52_p256_)(U64 r[], const U64 a[], const U64 b[])
{
   MB_FUNC_NAME(ifma_sub52x5_)(r, a, b, (U64*)p256_mb);
}

void MB_FUNC_NAME(ifma_neg52_p256_)(U64 r[], const U64 a[])
{
   MB_FUNC_NAME(ifma_neg52x5_)(r, a, (U64*)p256_mb);
}

void MB_FUNC_NAME(ifma_double52_p256_)(U64 r[], const U64 a[])
{
   MB_FUNC_NAME(ifma_add52x5_)(r, a, a, (U64*)p256_mb);
}

void MB_FUNC_NAME(ifma_tripple52_p256_)(U64 r[], const U64 a[])
{
   U64 t[LEN52];
   MB_FUNC_NAME(ifma_add52x5_)(t, a, a, (U64*)p256_mb);
   MB_FUNC_NAME(ifma_add52x5_)(r, t, a, (U64*)p256_mb);
}
