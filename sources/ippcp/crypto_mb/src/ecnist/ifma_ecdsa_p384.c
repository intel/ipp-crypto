                                   ...
                                   P384_POINT* W)
{
    ...
    MB_FUNC_NAME(get_nistp384_ec_projective_coords_)(sign_r_restored, NULL, &P);
                                               ...
                                               int8u* pBuffer)
{
    ...
    */
    __mb_mask
    missmatch_param_err_mask = MB_FUNC_NAME(ifma_check_range_n384_)(msg);
    missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n384_)(sign_r);
    missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_n384_)(sign_s);
    ...
    missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p384_)(W.X);
    missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p384_)(W.Y);
    missmatch_param_err_mask |= MB_FUNC_NAME(ifma_check_range_p384_)(W.Z);
