                                     ...
                                     int8u* pBuffer)
{
   ...
   */
   if( MBX_IS_ANY_OK_STS(status) ) {
      ...
      ifma_BN_transpose_copy((int64u (*)[])secretz, (const BIGNUM**)pa_skey, P384_BITSIZE);
      ...
      /* to regular domain */
      ifma_frommont52_p384_mb8(R.X, R.X);

      /* store result */
      ifma_mb8_to_HexStr8(pa_shared_key, (const int64u (*)[])R.X, P384_BITSIZE);
   ...
   */
   if( MBX_IS_ANY_OK_STS(status) ) {
      ...
      if(use_jproj_coords)
         ...
         MB_FUNC_NAME(mov_FE384_)(P.Z, (U64*)ones);
      /* convert to Montgomery */
      ifma_tomont52_p384_mb8(P.X, P.X);
      ifma_tomont52_p384_mb8(P.Y, P.Y);
      ifma_tomont52_p384_mb8(P.Z, P.Z);
