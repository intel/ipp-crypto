...
//
// Note:
// output public key is represented either
                                              ...
                                              int8u* pBuffer)
{
   ...
   */
   if( MBX_IS_ANY_OK_STS(status) ) {
      ...
      if(!use_jproj_coords)
         MB_FUNC_NAME(get_nistp256_ec_projective_coords_)(P.X, P.Y, &P);
                                          ...
                                          int8u* pBuffer)
{
   ...
   */
   if( MBX_IS_ANY_OK_STS(status) ) {
      ...
      /* convert P coordinates to regular domain */
      ifma_frommont52_p256_mb8(P.X, P.X);
      ifma_frommont52_p256_mb8(P.Y, P.Y);
      if(use_jproj_coords)
         ifma_frommont52_p256_mb8(P.Z, P.Z);
