...
// do we need funtions
//    - set_P384_POINT_to_infinity(), 
//    - is_P384_POINT_at_infinity()
//
//    - set_P384_POINT_AFFINE_to_infinity()
//    - is_P384_POINT_AFFINE_at_infinity()
...
const U64* MB_FUNC_NAME(ifma_ec_nistp384_coord_one_)(void)
{
   return (U64*)p384_r_mb;
}
...
void MB_FUNC_NAME(get_nistp384_ec_projective_coords_)(U64 x[], U64 y[], const P384_POINT* P)
{
