...
__ALIGN64 static const int64u ones[P384_LEN52][8] = {
   { REP8_DECL(1) },
   { REP8_DECL(0) },
   { REP8_DECL(0) },
   { REP8_DECL(0) },
...
EXTERN_C void MB_FUNC_NAME(ifma_amm52x8_)(U64 r[], const U64 a[], const U64 b[], const U64 m[], const int64u k0[]);

/* Specialized single and dual operations over NIST P384 */
