...
SQR_448  MACRO    rDst, rSrc, x7, x6, x5, x4, x3, x2, x1, x0, A, x8, t0
   ;; ------------------
   ;; first pass 01...06
   ;; ------------------
   mov   A, x0
   ...
   ;; ------------------
   mov      rax, [rSrc + sizeof(qword)*3]
   mul      qword ptr[rSrc + sizeof(qword)*4]
   add      x6, rax
   adc      rdx, 0
   add      x7, rdx
   adc      x8, 0
   ...
   mul      qword ptr[rSrc + sizeof(qword)*6]
   add      x7, rax
   adc      rdx, 0
   add      x8, rdx
   adc      x0, 0
...
SQR_384  MACRO rDst, rSrc, x7, x6, x5, x4, x3, x2, x1, x0, A, x8, t0
   mov   A, x0
   mov      rax, x1
   mul      A
   mov      x0, rax
   ...
   mov      A, qword ptr [rSrc+ sizeof(qword)*1]
   ...
   mov      A, qword ptr [rSrc+ sizeof(qword)*2]
   ...
   mov      A, qword ptr [rSrc+ sizeof(qword)*3]
   mov      rax, qword ptr [rSrc+ sizeof(qword)*4]
   mul      A
   xor      x8, x8
   add      x6, rax
   mov      rax, qword ptr [rSrc+ sizeof(qword)*5]
   adc      x7, rdx
   adc      x8, 0
   mul      A
   mov      A, qword ptr [rSrc+ sizeof(qword)*4]
   add      x7, rax
   mov      rax, qword ptr [rSrc+ sizeof(qword)*5]
   adc      x8, rdx
...
SQR_320  MACRO rDst, rSrc, x7, x6, x5, x4, x3, x2, x1, x0, A, x8, t0
   mov   A, x0
   mov      rax, x1
   mul      A
   mov      x0, rax
...
SQR_256  MACRO rDst, rSrc, x7, x6, x5, x4, x3, x2, x1, x0, A, x8, t0
   ;; ------------------
   ;; first pass 01...03
   ;; ------------------
   mov   A, x0
...
SQR_192  MACRO rDst, rSrc, x7, x6, x5, x4, x3, x2, x1, x0, A, x8, t0
   mov      A, x0
   ...
   mov      rax, qword ptr [rSrc+ sizeof(qword)*1]
   mul      qword ptr [rSrc+ sizeof(qword)*2]
   xor      x3, x3
   add      x2, rax
   adc      x3, rdx
   ...
   mov      rax, qword ptr [rSrc+ sizeof(qword)*0]
   mul      rax
   mov      x4, rax
   mov      x5, rdx
   ...
   mov      qword ptr [rDst+sizeof(qword)*0], x4
   add      x5, x0
   mov      qword ptr [rDst+sizeof(qword)*1], x5
   adc      x6, x1
   mov      qword ptr [rDst+sizeof(qword)*2], x6
   adc      x7, x2
   mov      qword ptr [rDst+sizeof(qword)*3], x7
   adc      rax, x3
   mov      qword ptr [rDst+sizeof(qword)*4], rax
   adc      rdx, A
...
ALIGN IPP_ALIGN_FACTOR
SQR2:    ;; len=2
   mov   rax, qword ptr [rsi]                ; a[0]
   mul   qword ptr [rsi+sizeof(qword)*1]     ; a[0]*a[1]
   xor   A, A
   mov   x2, rax
   mov   x3, rdx
   ...
   mov   rax, qword ptr [rsi+sizeof(qword)*1]; a[1]
   mul   rax                                 ; (rdx:rax) = a[1]^2

   mov   qword ptr[rdi+sizeof(qword)*0], x0
   add   x1, x2
   mov   qword ptr[rdi+sizeof(qword)*1], x1
   adc   rax, x3
   mov   qword ptr[rdi+sizeof(qword)*2], rax
   adc   rdx, A
   mov   qword ptr[rdi+sizeof(qword)*3], rdx
   mov   rax, rdx
   REST_XMM
   REST_GPR
   ret
...
;; stack structure:
pDst  = (0)
pSrc  = (pDst+sizeof(qword))
len   = (pSrc+sizeof(qword))

;;
;; assignment
B0 equ   r10   ; a[i], a[i+1]
B1 equ   r11
...
init_even_len_operation:
   mov      B0,  qword ptr [rsi+idx*sizeof(qword)-sizeof(qword)]  ; B0 = a[0]
   mov      rax, qword ptr [rsi+idx*sizeof(qword)]                ; a[1]
   xor      T0, T0
   cmp      idx, 0
   jge      skip_mul1
...
init_odd_len_operation:
   mov      B0, qword ptr [rsi+idx*sizeof(qword)-2*sizeof(qword)]    ; a[0] and a[1]
   mov      B1, qword ptr [rsi+idx*sizeof(qword)-sizeof(qword)]

   mov      rax, B1     ; a[0]*a[1]
   mul      B0

   mov      qword ptr [rdi+idx*sizeof(qword)-sizeof(qword)], rax
   mov      rax, qword ptr [rsi+idx*sizeof(qword)]                   ; a[2]
   mov      T0, rdx
...
add_diag:
   ...
   mov      qword ptr [rdi], T0                                   ; r[0] = 0
   mov      qword ptr [rax+rcx*sizeof(qword)-sizeof(qword)], T0   ; r[2*len-1] = 0
   neg      rcx

ALIGN IPP_ALIGN_FACTOR
add_diag_loop:
   mov      rax, qword ptr [rsi+rcx*sizeof(qword)] ; a[i]
   mul      rax
   mov      T2, qword ptr [rdi]                    ; r[2*i]
   mov      T3, qword ptr [rdi+sizeof(qword)]      ; r[2*i+1]
   add      T0, 1
   adc      T2, T2
   adc      T3, T3
   sbb      T0, T0
   ...
   adc      T3, rdx
   sbb      T1, T1
   mov      qword ptr [rdi], T2
   mov      qword ptr [rdi+sizeof(qword)], T3
