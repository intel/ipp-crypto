...
;*************************************************************
ALIGN IPP_ALIGN_FACTOR
IPPASM cpMulAdx_BNU_school PROC PUBLIC FRAME
...
quit:
   ...
   REST_GPR
   ret
IPPASM cpMulAdx_BNU_school ENDP
...
;*************************************************************
ALIGN IPP_ALIGN_FACTOR
IPPASM cpSqrAdx_BNU_school PROC PUBLIC FRAME
   USES_GPR rbx,rbp,rsi,rdi,r12,r13,r14,r15
   LOCAL_FRAME = 0
   USES_XMM
   COMP_ABI 3
...
quit:
   ...
   REST_GPR
   ret
IPPASM cpSqrAdx_BNU_school ENDP
...
;*************************************************************
ALIGN IPP_ALIGN_FACTOR
IPPASM cpMontRedAdx_BNU PROC PUBLIC FRAME
      USES_GPR rbx,rbp,rsi,rdi,r12,r13,r14,r15
      LOCAL_FRAME = (0)
      USES_XMM
      COMP_ABI 5
