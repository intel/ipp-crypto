...
IPPASM cpSub_BNU PROC PUBLIC FRAME
...
;********** lenSrcA == 2 *************************************
    ...
    sbb     r8, qword ptr [rdx]             ; r8  = a0-b0 = s0
    mov     r9, qword ptr [rsi+8]           ; r9  = a1
    sbb     r9, qword ptr [rdx+8]           ; r9  = a1-b1 = s1
...
;********** lenSrcA == 3 *************************************
    ...
    sbb     r10, qword ptr [rdx+16]         ; r10 = a2-b2 = s2
    mov     qword ptr [rdi], r8             ; save s0
    mov     qword ptr [rdi+8], r9           ; save s1
...
;********** lenSrcA == 4 *************************************
    ...
    sbb     r11, qword ptr [rdx+24]         ; r11 = a3-b3 = s3
    mov     qword ptr [rdi], r8             ; save s0
    mov     qword ptr [rdi+8], r9           ; save s1
    mov     qword ptr [rdi+16], r10         ; save s2
...
;********** lenSrcA == 5 *************************************
    ...
    sbb     rcx, qword ptr [rdx+32]         ; rcx = a4-b4 = s4
    mov     qword ptr [rdi], r8             ; save s0
    mov     qword ptr [rdi+8], r9           ; save s1
    mov     qword ptr [rdi+16], r10         ; save s2
...
;********** lenSrcA == 6 *************************************
    ...
    sbb     rsi, qword ptr [rdx+40]         ; rsi = a5-b5 = s5
    mov     qword ptr [rdi], r8             ; save s0
    mov     qword ptr [rdi+8], r9           ; save s1
    mov     qword ptr [rdi+16], r10         ; save s2
    mov     qword ptr [rdi+24], r11         ; save s3
...
;********** lenSrcA == 7 *************************************
    ...
    sbb     r8, qword ptr [rdx+40]          ; r8  = a5-b5 = s5
    mov     rsi, qword ptr [rsi+48]         ; rsi = a6
    sbb     rsi, qword ptr [rdx+48]         ; rsi = a6-b6 = s6
    mov     qword ptr [rdi+8], r9           ; save s1
    mov     qword ptr [rdi+16], r10         ; save s2
    mov     qword ptr [rdi+24], r11         ; save s3
    mov     qword ptr [rdi+32], rcx         ; save s4
...
;********** lenSrcA == 8 *************************************
    ...
    sbb     r9, qword ptr [rdx+48]          ; r9  = a7-b7 = s7
    mov     rsi, qword ptr [rsi+56]         ; rsi = a6
    sbb     rsi, qword ptr [rdx+56]         ; rsi = a6-b6 = s6
    mov     qword ptr [rdi+16], r10         ; save s2
    mov     qword ptr [rdi+24], r11         ; save s3
    mov     qword ptr [rdi+32], rcx         ; save s4
    mov     qword ptr [rdi+40], r8          ; save s5
...
SUB_GLOOP:
    ...
    sbb     r8, qword ptr [rdx+8*rcx]       ; r8  = a0+b0 = r0
    sbb     r9, qword ptr [rdx+8*rcx+8]     ; r9  = a1+b1 = r1
    sbb     r10, qword ptr [rdx+8*rcx+16]   ; r10 = a2+b2 = r2
    sbb     r11, qword ptr [rdx+8*rcx+24]   ; r11 = a3+b3 = r3
...
SUB_LLOOP:
    ...
    mov     r8, qword ptr [rsi]             ; r8  = a0
    mov     r9, qword ptr [rsi+8]           ; r9  = a1
    sbb     r8, qword ptr [rdx]             ; r8  = a0+b0 = r0
    sbb     r9, qword ptr [rdx+8]           ; r9  = a1+b1 = r1
