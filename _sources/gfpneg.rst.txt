...
IppStatus ippsGFpNeg(const IppsGFpElement\* pA, IppsGFpElement\* pR,
IppsGFpState\* pGF);
...
This function computes the additive inverse of an element of the finite
field. The following pseudocode represents this operation:
``R + A = 0``. The finite field is specified by the context pGFp.
