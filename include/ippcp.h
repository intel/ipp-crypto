...
// =========================================================
*/
IPP_DEPRECATED("is deprecated. This function is obsolete and will be removed in one of the future Intel IPP Cryptography releases") \
...
IPP_DEPRECATED("is deprecated. This API is considered obsolete and will be removed in one of future Intel IPP Cryptography releases. Use the following link for opening a ticket and providing feedback: https://supporttickets.intel.com/ if you have concerns.") \
